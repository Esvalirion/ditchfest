...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Подпись темы дичфеста, чтобы все знали что за тема (через админ-аккаунт).' },
  ...
  },
  {
    ...
    items: [
      { text: 'Объединение карт под общими темами (а не по кампании) от имени админа. Надо подумать над дизайном и оценить сложность.' },
